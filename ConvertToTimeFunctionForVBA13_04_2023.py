...
# file_name = 'czas_pracy_1.4.12_Pawel_Bednarczyk_IV_2023_04-13.xlsm'

try:
    # load xls file ->from pandass
    # nie dziala: d = pd.read_csv(r'czas_pracy_1.4.12_Pawel_Bednarczyk_IV_2023_04-13.csv', header=None)
    d = pd.read_excel(r'czas_pracy_1.4.12_Pawel_Bednarczyk_IV_2023_04-13.xlsm')
